...
async function buildRomTables(romMetadataMap: Record<string, RomMetadata>, romId: string): Promise<[Scaling[], Record<string, Table>]> {
...
export const LoadRomMetadata = async (selectedDirectoryHandle: FileSystemDirectoryHandle, selectedRomMetadataHandle: FileSystemFileHandle) => {
