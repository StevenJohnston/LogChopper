...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const { scalingMap, tableMap } = await LoadRomMetadata(directoryHandle, defaultRomMetadata)
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const { scalingMap, tableMap } = await LoadRomMetadata(directoryHandle, selectedRomMetadataHandle)
      setScalingMap(scalingMap)
      setTableMap(tableMap)
    })()
