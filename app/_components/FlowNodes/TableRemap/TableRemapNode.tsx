...
import { TableRemapData, TableRemapAxis, TableRemapSource } from './TableRemapTypes';
...
function TableRemapNode({ id, data }: NodeProps<TableRemapData>) {
  ...
  return (
    <div className="flex flex-col border border-gray-500 rounded-md p-2 bg-sky-500/75">
      ...
      <CustomHandle dataType='3D' type="target" position={Position.Left} id="a" top="20px" />
      <CustomHandle dataType='3D' type="target" position={Position.Left} id="b" top="60px" />
      <CustomHandle dataType='3D' type="source" position={Position.Right} id="output" />
